...
import SilverCalculationPage from "./pages/SilverCalculationPage";
import OrderSuccess from "./components/Orderplace";  
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/silver-calc" element={<SilverCalculationPage />} />
      ...
      <Route path="/filter/:slug" element={<CategoryProductsPage />} />
      {/* 🔒 PROTECTED ROUTES */}
      <Route
        path="/cart"
        element={
