  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="bg-gradient-to-r from-[#7A4A4A] to-[#b46b74] text-white px-6 py-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm opacity-90">+91 {user.mobile}</p>
          </div>
        </div>
      ...
      <div className="px-6 py-6 space-y-4">
        <ProfileItem title="My Orders" onClick={() => navigate("/orders")} />
        <ProfileItem title="Wishlist" onClick={() => navigate("/wishlist")} />
        {/* <ProfileItem
          title="Saved Addresses"
          onClick={() => navigate("/addresses")}
        /> */}
        <ProfileItem title="Support" onClick={() => navigate("/support")} />
      </div>
