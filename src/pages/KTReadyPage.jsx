...
const subCategories22KT = [
  {
    title: "Plain Casting",
    img: "https://cdn.quicksell.co/-NVt4TaiE3Hhq0fNqKM6/products/-OZEwW2n_I7G6jGqrwE4.jpg",
    slug: "plain-casting",
    description: "Elegant handcrafted gold designs"
  },
  {
    title: "CZ Casting",
    img: "https://cdn.quicksell.co/-NVt4TaiE3Hhq0fNqKM6/products/-OZEwW2n_I7G6jGqrwE4.jpg",
    slug: "cz-casting",
    description: "Brilliant CZ embedded jewellery"
  },
  {
    title: "Paper Casting",
    img: "https://cdn.quicksell.co/-NVt4TaiE3Hhq0fNqKM6/products/-OZEwW2n_I7G6jGqrwE4.jpg",
    slug: "paper-casting",
    description: "Lightweight casting designs"
  },
  {
    title: "Chain",
    img: "https://cdn.quicksell.co/-NVt4TaiE3Hhq0fNqKM6/products/-OZEwW2n_I7G6jGqrwE4.jpg",
  ...
  },
  {
    ...
    img: "https://cdn.quicksell.co/-NVt4TaiE3Hhq0fNqKM6/products/-OZEwW2n_I7G6jGqrwE4.jpg",
    slug: "cuban",
    description: "Classic Cuban link jewellery"
  }
];
...
const KTReadyPage = () => {
  ...
  const handleSubCategoryClick = (subCategorySlug) => {
    navigate(`/collection/22kt-ready/${subCategorySlug}/1`);
  };
      ...
      <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
        ...
        <div className="bg-gradient-to-r from-yellow-800 via-yellow-700 to-amber-700 text-white py-12">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-3">22KT Ready Collection</h1>
            <p className="text-xl opacity-90 max-w-3xl">
              Premium 22 karat gold jewellery with exquisite craftsmanship
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {subCategories22KT.map((subCat, index) => (
              <div
                key={index}
              ...
              >
                <div className="relative overflow-hidden h-56">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <h3 className="text-xl font-bold text-white">{subCat.title}</h3>
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-amber-700 font-medium">View Collection</span>
        ...
        <div className="bg-white border-t border-amber-100 py-12">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">
              About 22KT Gold Jewellery
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                <div className="text-4xl mb-4">🛡️</div>
                <h3 className="font-semibold text-lg mb-2">91.6% Pure Gold</h3>
                <p className="text-gray-600">22 karat means 91.6% pure gold content</p>
              </div>
              <div className="text-center p-6">
                <div className="text-4xl mb-4">✨</div>
                <h3 className="font-semibold text-lg mb-2">Traditional Craft</h3>
